...
Filter _$FilterFromJson(Map<String, dynamic> json) => Filter(
      ...
      since: _dateTimeFromJson(json['since'] as int?),
      until: _dateTimeFromJson(json['until'] as int?),
...
Map<String, dynamic> _$FilterToJson(Filter instance) {
  ...
  writeNotNull('since', _dateTimeToJson(instance.since));
  writeNotNull('until', _dateTimeToJson(instance.until));
